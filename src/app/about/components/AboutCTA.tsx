            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 backdrop-blur-sm border border-white/20 mb-6">
                        ...
                        <span className="text-white text-sm font-medium">Special Offer – 25% Off</span>
                    </div>
                    ...
                    <p className="text-white/80 text-base sm:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
                        Experience luxury beauty care and personalized service at Nikky Bawa Ladies Salon. Let our professionals help you look and feel your absolute best.
                    </p>

...
export default function FloatingButtons() {
    return (
        <>
            {/* WhatsApp Button */}
            <a
                href="https://wa.me/919981415156?text=Hi%2C%20I%20would%20like%20to%20book%20an%20appointment"
                target="_blank"
                ...
                style={{ background: "#25D366", animation: "pulse-glow 2s ease infinite" }}
